...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
      ...
      Lcd_cursor(&lcd, 0,1);
      Lcd_string(&lcd, "Infant .F");
      Lcd_cursor(&lcd, 1,1);
      Lcd_string(&lcd, "212224230095");
  /* Infinite loop */
...
<img width="1152" height="946" alt="image" src="https://github.com/user-attachments/assets/e5936a35-d40f-4525-9904-608b4f6bc011" />
